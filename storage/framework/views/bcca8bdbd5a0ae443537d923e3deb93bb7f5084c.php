...
<div style="padding-left: 10px;">
    <h6><b><?php echo e($newsDetails->news_title); ?></b></h6>
</div>
                    ...
                    <tr>
                        <td valign="top" align="left">
                            <table class="" data-module-id="eml_int_banner" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                <tr>
                                    <td id="campaignImage" style="background-image:url('<?php echo e(asset('uploads/news_image/'.$newsDetails->news_image)); ?>');background-repeat:no-repeat;background-size:100% auto" class="mb-bnr tmpImage" data-browse="true" data-others="true" data-setheight="true" data-helptext="N/A" width="614" valign="middle" height="137" align="left">
                                                ...
                                                <td style="padding:0 20px 0 35px;height:137px" class="height0" id="bannerTxt" valign="middle" align="left">
                                                    <table class="opd-l20" width="100%" border="0">
                                                        ...
                                                        <tr class="tmpAddRemoveText">
                                                            <td class="fs18" style="font-family:'Georgia';font-size:24px;color:#fff;font-weight:bold" data-textalign="true" valign="top" align="left"> <span class="tmpTitle" data-font="defaultFontTitle24" data-personalization="false" disable-edtr-icon="Link,UnLink" data-char="28" data-helptext="28 char max"><?php echo e($newsDetails->news_title); ?> </span></td>
                                                        </tr>
                                                        <tr class="tmpAddRemoveText">
                                                                ...
                                                                <table class="devicewidthinner" width="100%" border="0">
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-family:'Oracle Sans';font-size:16px;color:#000;padding-bottom:10px" class="fs14" valign="top" align="left">
                                                                            ...
                                                                            <?php echo $newsDetails->news_desc; ?>
