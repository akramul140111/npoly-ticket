<?php $__env->startSection('content'); ?>
    ...
    <?php $actionUrl=url('/updateTicketDetails'); ?>
    <script>$('form').parsley();</script>
    <?php ini_set('memory_limit', -1) ?>
    <div class="flash-message"></div>
    <div class="x_content">
        <form id="projectSetupForm" data-parsley-validate="" role="form" method="post" action="<?php echo e(url('/updateTicketDetails/'.$id)); ?>"
              class="form-label-left" enctype="multipart/form-data" autocomplete="off">
            <?php echo csrf_field(); ?>
            <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Status *</label>
                <div class="col-md-6 col-sm-6">
                    <select class=" form-control ticket-status" name="ticket_status" id="" style="width: 500px !important;">
                        ...
                        <?php $__currentLoopData = $ticketStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status->lookup_data_id); ?>"><?php echo e($status->lookup_data_name); ?></option>
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                   <textarea class="form-control" required name="update_details" cols="5" rows="3" style="width: 500px !important;"><?php echo e($ticketDetailsInfo->update_details); ?></textarea>
                    <div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click','#btnSubmit',function (){
            var reasonId = $('.ticket-status').val();
            if(reasonId==''){
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/support_user/updateTicketDetails.blade.php ENDPATH**/ ?>