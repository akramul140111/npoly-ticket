            ...
            <div class="card">
                <div style="text-align: center;line-height:0px">
                    <a href="#" class="site_title">
                        <img class="" style="height:50px !important;"
                            src="<?php echo e(url('images/birdem-general-hospital-banner-mail.jpg')); ?>">
                    </a>
                </div>
                <div class="card-header" style="text-align: center">
                    <h1><?php echo e(__('Password Reset')); ?></h1>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-success" role="alert" style="text-align: center;line-height: 0px">
                        <?php echo e(__('Hi, Dear Sir/Madam.')); ?>

                        <p>If you've lost your password or wish to reset it.
                            Use the link below to get started.
                            <br> <br> <a href="<?php echo e($actionUrl); ?>"
                                ...
                                PASSWORD </a><br> <br>
                            If the link is not working, simply <a href="<?php echo e(url('/forgetPassword')); ?>"> request a new
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/customauth/verify.blade.php ENDPATH**/ ?>