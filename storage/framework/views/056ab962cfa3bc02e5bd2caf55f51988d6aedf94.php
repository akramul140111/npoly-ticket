                                        ...
                                        <table id="datatable" class="table table-striped table-bordered dataTable"
                                            ...
                                            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(date('d-M-Y',strtotime($result->attendance_date))); ?></td>
                                                    <td><span <?php if($result->login_time >33399): ?> style="color: red;" <?php endif; ?>><?php echo e(gmdate('H:i A',$result->login_time)); ?></span></td>
                                                </tr>
