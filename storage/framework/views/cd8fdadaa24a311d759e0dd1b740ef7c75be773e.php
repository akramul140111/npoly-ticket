            ...
            <div class="title_right">
                <div class="item form-group">
                    <div class="col-md-3 col-sm-3 offset-md-9">
                        <button type="button" class="btn btn-primary dynamicModal" pageTitle="Add Project"
                            pageLink="<?php echo e(URL::route('createProjectSetup')); ?>" data-toggle="tooltip" data-placement="left"
                            title="Add Project" data-target=".bs-example-modal-lg" data-modal-size="modal-xl">Add
                            New</button>
                    </div>
                </div>
            </div>
                                                ...
                                                <td>Open</td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-info btn-sm dynamicModal"
                                                            ...
                                                            pageLink="<?php echo e(url('/updateProject/'.$result->project_id)); ?>"
                                                            data-modal-size="modal-xl" data-toggle="tooltip"
                                                            data-placement="top" title="Update Project">
