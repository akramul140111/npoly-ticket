<?php $__env->startSection('content'); ?>
    ...
    <?php $actionUrl=url('/storeSupportTicket'); ?>
...
<?php if($requestMode): ?>
            ...
            <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">System Lifecycle*</label>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Module*</label>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Severity*</label>
                <div class="col-md-6 col-sm-6">
                    <select class="form-control" name="priority_id" required>
                        <option value="">--select--</option>
                        <?php if($priority): ?>
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <select class="form-control" name="contact_person" id="contact_person" required>
                        <option value="">--select--</option>
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($conp->employee_id); ?>"><?php echo e($conp->employee_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/support_user/create.blade.php ENDPATH**/ ?>