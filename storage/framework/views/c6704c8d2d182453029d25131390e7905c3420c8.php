                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-4" style="display: inline-block;float: left">
                                           ...
                                           <span><span style="color: #c19751;">Last Updated</span> <span style="color: #003D5B"><?php echo e($lastUpdate); ?> ago</span></span>
                                        </div>
                                        <div style="display: inline-block;float: left">
                                            <button class="btn btn-info btnStyle dynamicModal" pageLink="<?php echo e(url('/updateTicketDetails/'.$ticketDetails->id)); ?>" data-toggle="tooltip" data-placement="left" pageTitle="Update <?php echo e($ticketDetails->ticket_no); ?>" title="Update Details" data-target=".bs-example-modal-sm" data-modal-size="modal-lg">Add Update</button>
                                        </div>
                                        <div style="display: inline-block;float: left">
                                            <button class="btn btn-info btnStyle dynamicModal" pageLink="<?php echo e(url('/updateTicketAttachment/'.$ticketDetails->id)); ?>" data-toggle="tooltip" data-placement="left" pageTitle="Update <?php echo e($ticketDetails->ticket_no); ?>" title="Update Attachment" data-target=".bs-example-modal-sm" data-modal-size="modal-lg">Add Attachment</button>
                                        </div>
                                        <div style="display: inline-block;float: left">
                                            <button class="btn btn-info btnStyle dynamicModal" pageLink="<?php echo e(url('/updateCloseTicket/'.$ticketDetails->id)); ?>" data-toggle="tooltip" data-placement="left" pageTitle="Update <?php echo e($ticketDetails->ticket_no); ?>" title="Update Attachment" data-target=".bs-example-modal-sm" data-modal-size="modal-lg">Close SR</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
