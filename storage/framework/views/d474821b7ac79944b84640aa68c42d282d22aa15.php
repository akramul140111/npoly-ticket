    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo e(url('get_ticket_info/225')); ?>">
                <div class="ibox bg-info color-white widget-stat">
                    <div class="ibox-body">
                        <h2 class="m-b-5 font-strong"><?php echo e($openTicket); ?></h2>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo e(url('get_ticket_info/234')); ?>">
                    <div class="ibox bg-warning color-white widget-stat">
                        <div class="ibox-body">
                            <h2 class="m-b-5 font-strong"><?php echo e($pendingTicket); ?></h2>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo e(url('get_ticket_info/227')); ?>">
                    <div class="ibox bg-success color-white widget-stat">
                        <div class="ibox-body">
                            <h2 class="m-b-5 font-strong"><?php echo e($wProgressTicket); ?></h2>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo e(url('get_ticket_info/229')); ?>"><div class="ibox bg-danger color-white widget-stat">
                        <div class="ibox-body">
                            <h2 class="m-b-5 font-strong"><?php echo e($notResolvedTicket); ?></h2>
        ...
        <div>
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <a href="<?php echo e(url('get_ticket_info/228')); ?>">
                        <div class="ibox bg-success color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo e($ResolvedTicket); ?></h2>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?php echo e(url('get_ticket_info/1')); ?>">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo e($ReassignTicket); ?></h2>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?php echo e(url('get_ticket_info/230')); ?>"><div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo e($closeTicket); ?></h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table class="tile_info">
                                        <tr>
                                            <td>
                                               <a href="<?php echo e(url('/allEmployeeIndex')); ?>"> <p title="Total Employee"><i class="fa fa-square blue"></i>Total Emp </p></a>
                                            </td>
                                            <td> <a href="<?php echo e(url('/allEmployeeIndex')); ?>"><span id="">9
                                                    <input type="hidden" id="totalEmp" value="9">
                                                    </span></a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(url('/total_present_employee')); ?>"> <p title="Total Present"><i class="fa fa-square green"></i>Present</p></a>
                                            </td>
                                            <td> <a href="<?php echo e(url('/total_present_employee')); ?>">
                                                  <span id="totalPresent"><?php echo e($totalPresent); ?></span>
                                                </a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(url('/total_absent_employee')); ?>"><p title="Total Absent"><i class="fa fa-square purple"></i>Absent</p></a>
                                            </td>
                                            <td><a href="<?php echo e(url('/total_absent_employee')); ?>"><span id="totalAbsent"><?php echo e($totalAbsent); ?></span></a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(url('/total_working_hour')); ?>"><p title="Total Working Hours"><i class="fa fa-square aero"></i>T.W.H </p></a>
                                            </td>
                                            <td><a href="<?php echo e(url('/total_working_hour')); ?>"><span id="totalHour"><?php echo e($totalHours); ?></span></a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(url('/get_last_seven_days_task')); ?>"> <p title="Last 7 Days Work"><i class="fa fa-square red"></i>Last 7 Days</p></a>
                                            </td>
                                            <td><a href="<?php echo e(url('/get_last_seven_days_task')); ?>"><span id="last7Days"><?php echo e(floor($totaHourlast7days->total_hours / 3600)); ?></span></a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
