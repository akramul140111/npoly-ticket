    ...
    <div class="x_content">
        <form id="closeReasonForm" data-parsley-validate="" role="form" method="post" action="<?php echo e(url('/updateCloseTicket/'.$id)); ?>"
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <textarea class="form-control" name="close_update_details" required cols="5" rows="3" style="width: 500px !important;"><?php echo e($closeTicketInfo->close_update_details); ?></textarea>
                    <div>
