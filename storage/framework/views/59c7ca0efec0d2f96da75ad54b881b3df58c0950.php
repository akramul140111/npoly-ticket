...
<table style="    border-collapse: collapse; width: 750px;  border: 1px #ccc solid; background: #fff; font-size: 11px; font-family: verdana, sans-serif;" align="center">
    ...
    <tr style="  color: #fff; background: #1B3073;  ">
        ...
        <td style="padding: 9px; color: #fff; background: #1B3073; width: 500px;">
            <p style="font-size: 16px; color: #ccc; display: inline-block; float: right; text-align:right; margin: 0px;">Ticket No :: <?php echo e($results->ticket_no); ?></p>
        </td>
    </tr>
    ...
    <tr style="padding: 10px;">
        ...
        <td style="width: 250px; vertical-align: top;">
            <div style="margin:15px 8px 15px;padding: 9px; border: 1px #ccc solid;">
                ...
                <?php echo e($results->module_name); ?> <br/>
                <br/><br/>
                <strong style="font-size: 13px; color: #1B3073;">Ticket Details: </strong><?php //echo $ticket_id;?>
                <hr style="height: 1px; color: #ccc;" />
                <strong style="font-size: 12px;    line-height: 15px;">Priority:</strong> <?php echo e($results->priority_name); ?> <br/>
                <strong style="font-size: 12px;    line-height: 15px;">Status:</strong> <?php echo e($results->ticket_status); ?><br/>
        ...
        <td style="width: 500px;  vertical-align: top;">
            <div style="margin:15px 8px 15px;padding: 9px; ">
                <strong style="font-size: 13px;">Title:</strong> <?php echo e($results->ticket_title); ?><br />
                <hr />
                <strong style="font-size: 13px;">Description:</strong>
                <p style="font-size: 11px;"><?php echo e($results->ticket_desc); ?></p>
            </div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="padding: 9px; color: #fff; background: #1B3073;">
            <p style="display: inline-block; float: right; text-align:right; margin: 0px;">Copyright &copy; <?php echo e(date('Y')); ?>. NPOLY GROUP. All rights reserved.<br /><small>Please do not reply this email.</small></p>
        </td>
    </tr>
    </tbody>
</table>
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/emails/ticket_mail.blade.php ENDPATH**/ ?>