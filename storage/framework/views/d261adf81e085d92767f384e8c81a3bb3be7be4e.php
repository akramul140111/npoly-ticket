<?php $__env->startSection('content'); ?> <?php echo $__env->make('layouts.modalFormSubmit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php $actionUrl=url('/storeLevel'); ?>
<script>
    $('form').parsley();
...
<div class="x_content">
    <form id="" data-parsley-validate="" role="form" method="post" action="<?php echo e($actionUrl); ?>" class="form-label-left"
        ...
        <!-- send group id  -->
        <input type="hidden" value="<?php echo e($id); ?>" name="group_id">
        ...
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <input class="form-control input-field-required-sign" name="level_name" id="level_name" placeholder=""
                    required />
            </div>
        </div>
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/security_access/user_group_level/create.blade.php ENDPATH**/ ?>