                    ...
                    <div class="field item form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <select class="form-control" name="group_name" id="groupName" required>
                                ...
                                <option value="<?php echo e($userGroup->USERGRP_ID); ?>"><?php echo e($userGroup->USERGRP_NAME); ?>
    ...
    $(document).ready(function () {
        $('#userLevel').on('change', function (e) {
           ...
           // alertify.alert(userLevel)
            ...
            $.ajax({
                url: "<?php echo e(route('assingLinkUserLevel')); ?>",
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    "userLevel":userLevel,
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#groupName').on('change', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('assingLinkUsergroup')); ?>",
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    group_name: group_name
