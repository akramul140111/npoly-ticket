                                  ...
                                  <?php
                                   ...
                                   ?>
                                    ...
                                    <tr id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                        ...
                                        <td>
                                            <label class="switch">                                           
                                            <input class="switchCreate" name="status"  id="CREATE" value="<?php echo e($moduleLink->CREATE); ?>"  <?php echo (!empty($moduleLinksCheck) ? ($moduleLinksCheck->CREATE == 1) ? "checked" : ""  : 0); ?>  type="checkbox" />
                                                <span class="slider round"></span>
                                            </label>
                                        </td>
                                        <!-- <td>
                                            <label class="switch">                                           
                                            <input class="switchRead" name="status"  id="READ" value="<?php echo e($moduleLink->READ); ?>" <?php echo (!empty($moduleLinksCheck) ? ($moduleLinksCheck->READ == 1) ? "checked" : ""  : 0); ?>   type="checkbox" />
                                                <span class="slider round"></span>
                                            </label>
                                        </td> -->
                                        <td>
                                            <label class="switch">                                           
                                            <input class="switchUpdate"  id="UPDATE" value="<?php echo e($moduleLink->UPDATE); ?>" <?php echo (!empty($moduleLinksCheck) ? ($moduleLinksCheck->UPDATE == 1) ? "checked" : ""  : 0); ?>   type="checkbox" />
                                                <span class="slider round"></span>
                                            </label>
                                        </td>
                                        <!-- <td>
                                            <label class="switch">                                          
                                            <input class="switchDelete"  id="DELETE" value="<?php echo e($moduleLink->DELETE); ?>" <?php echo (!empty($moduleLinksCheck) ? ($moduleLinksCheck->DELETE == 1) ? "checked" : ""  : 0); ?>   type="checkbox" />
                                                <span class="slider round"></span>
                                            </label>
                                        </td> -->
                                        <td>
                                        ...
                                        <input type="hidden" value="<?php echo e($moduleLink->SA_MLINKS_ID); ?>" class="SA_UGLWM_LINK">
                                        <input type="hidden" value="<?php echo e($module->MODULE_ID); ?>" class="MODULE_ID">
                                        <input type="hidden"  value="<?php echo e($moduleLink->SA_MLINKS_ID); ?>" />
                                        <input type="hidden" value="<?php echo e($moduleLink->LINK_ID); ?>" class="LINK_ID_A"> 
                                            <label class="switch">    
                                            <input class="switchStatus" id="STATUS" value="<?php echo e($moduleLink->STATUS); ?>" <?php echo (!empty($moduleLinksCheck) ? ($moduleLinksCheck->STATUS == 1) ? "checked" : ""  : 0); ?>  type="checkbox" />
...
$(document).off("change", ".switchStatus").on("change", ".switchStatus", function () {
    ...
    $.ajax({
            ...
            data: {"_token": "<?php echo e(csrf_token()); ?>","setVaue": setVaue, 
...
<?php /**PATH E:\xampp\htdocs\npoly-ticket\resources\views/security_access/add_page/showLinks.blade.php ENDPATH**/ ?>