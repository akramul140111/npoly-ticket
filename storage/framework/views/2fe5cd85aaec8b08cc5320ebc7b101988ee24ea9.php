                                        ...
                                        <table id="datatable" class="table table-striped table-bordered dataTable"
                                            ...
                                            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php if(!empty($result->card_no)): ?><?php echo e($result->card_no); ?><?php endif; ?></td>
                                                    <td><?php if(!empty($result->mobile_no)): ?><?php echo e($result->mobile_no); ?><?php endif; ?></td>
                                                    <td><?php if(!empty($result->department_name)): ?><?php echo e($result->department_name); ?><?php endif; ?></td>
                                                    <td><?php if(!empty($result->designation_name)): ?><?php echo e($result->designation_name); ?><?php endif; ?></td>
                                                    <td>
                                                        <?php
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-success btn-sm dynamicModal"
                                                                ...
                                                                pageLink="<?php echo e(url('/task_details_last_seven_days/'.$result->employee_id)); ?>"
