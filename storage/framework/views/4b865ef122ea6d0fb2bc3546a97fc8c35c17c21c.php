                ...
                <div class="item form-group">
                    <div class="col-md-3 col-sm-3 offset-md-9">
                        <button type="button" class="btn btn-primary dynamicModal" pageTitle="Add Module"
                            pageLink="<?php echo e(URL::route('createModuleSetup')); ?>" data-toggle="tooltip" data-placement="left"
                                                ...
                                                <td><?php echo e($result->deptName); ?></td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-info btn-sm dynamicModal"
                                                            ...
                                                            pageLink="<?php echo e(url('/updateSupportModule/'.$result->module_id)); ?>"
