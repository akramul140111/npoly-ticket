@section('content')
    ...
    @php $actionUrl=url('/updateTicketAttachment/'); @endphp
    <script>$('form').parsley();</script>
    <?php ini_set('memory_limit', -1) ?>
    <div class="flash-message"></div>
    <div class="x_content">
        <form id="projectSetupForm" data-parsley-validate="" role="form" method="post" action="{{url('/updateTicketAttachment/'.$id)}}"
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <textarea class="form-control" name="attachment_note" cols="5" rows="3" style="width: 500px !important;">{{$closeTicketInfo->attachment_note}}</textarea>
                    <div>
