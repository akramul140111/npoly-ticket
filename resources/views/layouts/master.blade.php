...
{{--    <link rel="stylesheet" href="{{ URL::asset('assets/vendors/fullcalendar/dist/fullcalendar.print.css') }}" />--}}
    ...
    {{-- Assets 2 --}}
    <link rel="stylesheet" href="{{ URL::asset('assets2/vendors/themify-icons/css/themify-icons.css') }}" />
...
<body class="nav-md">
 ...
 -->
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/vendors/echarts/dist/echarts.min.js') }}"></script>
