...
@php $actionUrl=url('/updateCourseSetup'); @endphp
<script>
    $('form').parsley();
...
<div class="x_content">
    <form id="CourseSetupForm" data-parsley-validate="" role="form" method="post" action="{{$actionUrl}}"
        ...
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <input class="form-control input-field-required-sign" name="total_seat_number"
                    value="{{$result->total_seat_number}}" required />
            </div>
        </div>
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Course Duration (Years)*</label>
            <div class="col-md-6 col-sm-6">
                <input class="form-control input-field-required-sign" name="course_duration"
                    value="{{$result->course_duration}}" required />
            </div>
        </div>
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <select class="form-control" name="number_of_phase" required>
                    ...
                    <option value="1" {{($result->number_of_phase==1)? 'selected':''}}>1</option>
                    <option value="2" {{($result->number_of_phase==2)? 'selected':''}}>2</option>
                    <option value="3" {{($result->number_of_phase==3)? 'selected':''}}>Not Applicable</option>
                </select>
            </div>
        </div>
        <div class="field item form-group">
