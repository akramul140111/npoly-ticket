            ...
            <div class="title_right">
                <div class="item form-group">
                    <div class="col-md-3 col-sm-3 offset-md-9">
                        <button type="button" class="btn btn-primary dynamicModal" pageTitle="Add Module"
                            pageLink="{{URL::route('createModuleSetup')}}" data-toggle="tooltip" data-placement="left"
                            title="Add Module" data-target=".bs-example-modal-lg" data-modal-size="modal-xl">Add
                            New</button>
                    </div>
                </div>
            </div>
                                                ...
                                                <td>{{$result->deptName}}</td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-info btn-sm dynamicModal"
                                                            ...
                                                            pageLink="{{url('/updateSupportModule/'.$result->module_id)}}"
