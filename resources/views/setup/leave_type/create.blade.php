...
@php $actionUrl=url('/storeLeaveTypeSetup'); @endphp
<script>
    $('form').parsley();
...
<div class="x_content">
    <form id="" data-parsley-validate="" role="form" method="post" action="{{$actionUrl}}" class="form-label-left"
        ...
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <select class="form-control" name="leaveType" id="LeaveType" required>
                    ...
                    <option value="{{$leaveType->LOOKUP_DATA_ID}}">{{$leaveType->LOOKUP_DATA_NAME}}</option>
                    @endforeach
        ...
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <input type="number" class="form-control input-field-required-sign" name="number_of_days"
                    id="number_of_days" placeholder="" required />
            </div>
        </div>
